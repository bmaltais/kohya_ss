...
def finetune_tab(
    ...
    with gr.Tab("Training"), gr.Column(variant="compact"):
        ...
        FIELD_REGISTRY = [
            ...
            ("sd3_fused_backward_pass", sd3_training.clip_g),
            ("clip_g", sd3_training.clip_l),
            ("clip_l", sd3_training.logit_mean),
            ("logit_mean", sd3_training.logit_std),
            ("logit_std", sd3_training.mode_scale),
            ("mode_scale", sd3_training.save_clip),
            ("save_clip", sd3_training.save_t5xxl),
            ("save_t5xxl", sd3_training.t5xxl),
            ("t5xxl", sd3_training.t5xxl_device),
            ("t5xxl_device", sd3_training.t5xxl_dtype),
            ("t5xxl_dtype", sd3_training.sd3_text_encoder_batch_size),
            ("sd3_text_encoder_batch_size", sd3_training.sd3_fused_backward_pass),
