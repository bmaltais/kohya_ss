...
LECO_FIELDS = [
    ...
    FieldSpec(
        ...
        info="guidance scale for the partial denoising pass / 部分デノイズ時のguidance scale",
        archs=None,
        training_types=frozenset({"leco"}),
        group="advanced",
        to_toml=_to_float,
    ...
    FieldSpec(
        ...
        info="number of partial denoising steps per iteration / 各イテレーションで部分デノイズするステップ数",
        archs=None,
        training_types=frozenset({"leco"}),
        group="advanced",
        to_toml=_to_int,
    ...
    FieldSpec(
        ...
        default=1.0,
        label="Network Alpha",
        info="network alpha / ネットワークのalpha",
        archs=None,
        training_types=frozenset({"leco"}),
        group="network",
        to_toml=_to_float,
    ...
    FieldSpec(
        ...
        info="network dropout / ネットワークのdropout",
        archs=None,
        training_types=frozenset({"leco"}),
        group="network",
        to_toml=_to_float,
    ...
    FieldSpec(
        ...
        info="unsupported for LECO; kept for compatibility / LECOでは未対応",
        archs=None,
        training_types=frozenset({"leco"}),
        group="network",
    ),
    FieldSpec(
        ...
        info="LECO always trains U-Net LoRA only / LECOは常にU-Net LoRAのみを学習",
        archs=None,
        training_types=frozenset({"leco"}),
        group="network",
    ),
    ...
    FieldSpec(
        ...
        default=False,
        label="No metadata",
        info="do not save metadata in output model / メタデータを保存しない",
        archs=None,
        training_types=frozenset({"leco"}),
        group="advanced",
    ),
    ...
    FieldSpec(
        ...
        default="",
        label="Prompts file",
        info="LECO prompt toml / LECO用のprompt toml",
        archs=None,
        training_types=frozenset({"leco"}),
        group="advanced",
    ),
