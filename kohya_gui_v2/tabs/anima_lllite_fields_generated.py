...
ANIMA_LLLITE_FIELDS = [
    ...
    FieldSpec(
        ...
        default=32,
        label="Cond emb dim",
        info="conditioning embedding dimension",
        archs=None,
        training_types=frozenset({"anima_lllite"}),
        group="advanced",
        to_toml=_to_int,
    ...
    FieldSpec(
        ...
        info="conditioning1 trunk channel width",
        archs=None,
        training_types=frozenset({"anima_lllite"}),
        group="advanced",
        to_toml=_to_int,
    ...
    FieldSpec(
        ...
        info="number of input channels for the LLLite conditioning1 trunk (default: 3, RGB only). Set to 4 to enable inpainting mode (RGB + 1ch mask).",
        archs=None,
        training_types=frozenset({"anima_lllite"}),
        group="advanced",
        to_toml=_to_int,
    ...
    FieldSpec(
        ...
        info="number of ResBlocks in conditioning1",
        archs=None,
        training_types=frozenset({"anima_lllite"}),
        group="advanced",
        to_toml=_to_int,
    ...
    FieldSpec(
        ...
        info="dropout rate for LLLite mid output",
        archs=None,
        training_types=frozenset({"anima_lllite"}),
        group="advanced",
        to_toml=_to_float,
    ...
    FieldSpec(
        ...
        info="[inpaint] additionally zero out RGB inside the mask region before concatenating with mask. Only effective when --lllite_cond_in_channels=4.",
        archs=None,
        training_types=frozenset({"anima_lllite"}),
        group="advanced",
    ),
    FieldSpec(
        ...
        info="LLLite MLP (LoRA-rank-like) hidden dim",
        archs=None,
        training_types=frozenset({"anima_lllite"}),
        group="advanced",
        to_toml=_to_int,
    ...
    FieldSpec(
        ...
        info="multiplier applied to LLLite output",
        archs=None,
        training_types=frozenset({"anima_lllite"}),
        group="advanced",
        to_toml=_to_float,
    ...
    FieldSpec(
        ...
        info="enable ASPP (Atrous Spatial Pyramid Pooling) at the end of conditioning1",
        archs=None,
        training_types=frozenset({"anima_lllite"}),
        group="advanced",
    ),
    ...
    FieldSpec(
        ...
        info="pretrained LLLite weights to resume from",
        archs=None,
        training_types=frozenset({"anima_lllite"}),
        group="network",
    ),
