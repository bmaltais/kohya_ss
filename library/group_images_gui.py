...
def gradio_group_images_gui_tab(headless=False):
    with gr.Tab("Group Images"):
        ...
        with gr.Row():
            ...
            button_input_folder = gr.Button("📂", elem_id="open_folder_small", visible=(not headless))
            ...
            button_output_folder = gr.Button("📂", elem_id="open_folder_small", visible=(not headless))
