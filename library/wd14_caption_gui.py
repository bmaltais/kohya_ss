...
from .common_gui import add_pre_postfix, get_folder_path
...
def gradio_wd14_caption_gui_tab(headless=False):
    with gr.Tab("WD14 Captioning"):
        gr.Markdown("This utility will use WD14 to caption files for each images in a folder.")
        ...
        with gr.Row():
            ...
            button_train_data_dir_input = gr.Button("📂", elem_id="open_folder_small", visible=(not headless))
        ...
        with gr.Row():
            onnx = gr.Checkbox(label="Use onnx", value=False, interactive=True, info="https://github.com/onnx/onnx")
        ...
        with gr.Row():
            ...
            max_data_loader_n_workers = gr.Number(value=2, label="Max dataloader workers", interactive=True)
