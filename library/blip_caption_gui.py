...
def gradio_blip_caption_gui_tab(headless=False):
    with gr.Tab("BLIP Captioning"):
        gr.Markdown("This utility uses BLIP to caption files for each image in a folder.")
        with gr.Row():
        ...
        with gr.Row():
            beam_search = gr.Checkbox(label="Use beam search", interactive=True, value=True)
