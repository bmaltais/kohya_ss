            ...
            for step, batch in enumerate(train_dataloader):
                ...
                with accelerator.accumulate(training_model):
                    ...
                    if  args.is_process_noisy_latents:
                        ...
                        noisy_latents = latent_util.process_noisy_latents(noisy_latents,model, process_latents,device,is_for_height = args.is_process_noisy_latents_height) * args.noisy_latents_weight + noisy_latents * (1-args.noisy_latents_weight)
