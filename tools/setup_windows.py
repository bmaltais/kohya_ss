...
def pip(arg: str, ignore: bool = False, quiet: bool = False, reinstall: bool = False):
    arg = arg.replace('>=', '==')
...
def get_torch_version_installed():
    file_path = os.path.join(".", "logs", "status", "torch_version")
    if os.path.exists(file_path):
